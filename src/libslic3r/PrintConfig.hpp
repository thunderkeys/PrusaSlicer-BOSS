...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,               first_layer_minimum_cruise_ratio_over_raft))
    ((ConfigOptionInt,                 first_layer_jerk_over_raft))
...
//  ((ConfigOptionFloat,               seam_preferred_direction_jitter))
    ...
    // BOSS
    ((ConfigOptionBool,                detect_narrow_solid_infill))
    ((ConfigOptionFloat,               detect_narrow_solid_infill_threshold))
)
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionEnum<FuzzySkinNoiseType>, fuzzy_skin_noise_type))
    ((ConfigOptionFloat,                fuzzy_skin_feature_size))
    ...
    // Disable external perimeters first for holes / layers
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloats,               prime_length_at_start))
)
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloat,              bridge_minimum_cruise_ratio))
    ((ConfigOptionInt,                bridge_jerk))
    ...
    ((ConfigOptionFloat,              external_perimeter_minimum_cruise_ratio))
    ((ConfigOptionInt,                external_perimeter_jerk))
    ...
    ((ConfigOptionFloat,              first_layer_minimum_cruise_ratio))
    ((ConfigOptionInt,                first_layer_jerk))
    ...
    ((ConfigOptionFloat,              infill_minimum_cruise_ratio))
    ((ConfigOptionInt,                infill_jerk))
    ...
    ((ConfigOptionFloat,              perimeter_minimum_cruise_ratio))
    ((ConfigOptionInt,                perimeter_jerk))
    ...
    ((ConfigOptionFloat,              solid_infill_minimum_cruise_ratio))
    ...
    ((ConfigOptionFloat,              top_solid_infill_minimum_cruise_ratio))
    ((ConfigOptionInt,                top_solid_infill_jerk))
    ((ConfigOptionEnum<ToolChangeOrderingType>, toolchange_ordering))
    ((ConfigOptionFloat,              travel_acceleration))
    ((ConfigOptionFloat,              travel_minimum_cruise_ratio))
    ((ConfigOptionInt,                travel_jerk))
    ((ConfigOptionFloat,              travel_short_distance_acceleration))
    ((ConfigOptionFloat,              travel_short_distance_minimum_cruise_ratio))
    ((ConfigOptionInt,                travel_short_distance_jerk))
    ((ConfigOptionBools,              wipe))
    ((ConfigOptionBool,               wipe_tower))
    ((ConfigOptionFloat,              wipe_tower_acceleration))
    ((ConfigOptionFloat,              wipe_tower_minimum_cruise_ratio))
    ((ConfigOptionInt,                wipe_tower_jerk))
